  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (authMode === 'signup') {
        ...
        // Sign in with AWS Cognito using email instead of username
          ...
          {(authMode === 'signin' || authMode === 'signup') && (
            ...
            >
              ...
              <motion.button
                ...
                className="w-full flex items-center justify-center gap-3 border border-gray-300 dark:border-gray-600 rounded-lg py-2.5 text-sm sm:text-base font-medium text-gray-700 dark:text-gray-200 bg-white/80 dark:bg-gray-800/80 hover:bg-white dark:hover:bg-gray-700 transition-all duration-200 disabled:opacity-60"
