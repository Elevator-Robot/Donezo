          ...
          >
            ...
            <div className="p-6">
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {fontOptions.map((font) => (
                      ...
                      >
                        ...
                        <p className="text-xs text-gray-600">Sample text</p>
                      </motion.button>
                    ))}
                  </div>
                </div>
                ...
                <div className="text-center pt-4 border-t border-gray-200">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Donezo</h3>
                  <p className="text-gray-600 mb-2">Get things done with style</p>
            ...
            <div className="flex justify-end p-6 border-t border-gray-200">
              <button
                ...
                className="px-6 py-3 text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-100 transition-colors duration-200"
              >
                Cancel
              </button>
              <button
