      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            transition={{ duration: 0.2 }}
            className="absolute right-0 top-full mt-2 w-56 sm:w-64 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200/50 dark:border-gray-700/50 z-50"
          >
            <div className="p-4">
              {/* User Info */}
